  ...
  if (searchButton && searchInput && resultsContainer && contentDisplay) {
    const searchResults = [
      ...
      },
      {
        title: "Fourmis",
        description: "Description de la page",
        link: "/public/Fourmis.html",
        image: "/img/icon/fourmis.webp",
      },
      {
        title: "Frelons_Asiatique",
        description: "Description de la page",
        link: "/public/Frelon_Asiatique.html",
        image: "/img/icon/frelon.webp",
      },
      {
        title: "Gale",
        description: "Description de la page",
        link: "/public/Gale.html",
        image: "/img/icon/gale.webp",
      },
      {
        title: "Guêpes-frelons",
        description: "Description de la page",
        link: "/public/Guêpes-frelons.html",
        image: "/img/icon/guêpe.webp",
      },
      {
        title: "Puce",
        description: "Description de la page",
        link: "/public/Puce.html",
        image: "/img/icon/puce.webp",
      },
      {
        title: "Punaise_De_Lit",
        description: "Description de la page",
        link: "/public/Punaise_De_Lit.html",
        image: "/img/icon/flea.webp",
      },
      {
        title: "Syndrome_De_Diogéne",
        description: "Description de la page",
        link: "/public/Syndrome_De_Diogéne.html",
        image: "/img/icon/diogene.webp",
      },
    ];
